...
class VentanaGestionUsuarios(QWidget):
    ...
    def personalizar_ventana(self):
        self.setWindowTitle("Extraccion Contratos y sus Comentarios")
    ...
    def cargar_datos(self):
        ...
        if conexion is not None:
            ...
            try:
                ...
                query = """SELECT a.cemptitu, a.finialar, a.ffinalar, a.cd_tp_alarma, a.ccontrps, b.id_crto_ext, b.cd_cups_ext, b.cd_sec_crto,
                           b.de_estado_crto, b.lg_activo, b.de_empr, b.fh_alta_crto, b.fh_baja_crto,
                           a.dcomenta, a.de_usuario, a.lg_origen
                ...
                QMessageBox.critical(self, "Error", f"Query Select: {str(e)}")
            finally:
                conexion.close()
        else:
    ...
    def obtener_conexion(self):
        ...
        try:
            ...
            QMessageBox.critical(self, "Error", f"Conexion: {str(e)}")
        return conn
