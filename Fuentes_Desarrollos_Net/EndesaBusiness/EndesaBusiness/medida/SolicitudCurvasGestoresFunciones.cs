...
{
    public class SolicitudCurvasGestoresFunciones : EndesaEntity.Solicitud
    {
        logs.Log ficheroLog = new logs.Log(Environment.CurrentDirectory, "logs", "CurvasDataMart_SolicitudFunciones");
        public SolicitudCurvasGestoresFunciones()
        {
