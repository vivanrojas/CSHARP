...
{
    public class SolicitudesCodigos : EndesaEntity.contratacion.Solicitudes_Codigos_Tabla
    {
        public Dictionary<string, EndesaEntity.contratacion.Solicitudes_Codigos_Tabla> dic { get; set; }
        public SolicitudesCodigos()
        {
        ...
        private void CargaDatos()
        {
            ...
            try
            {
                strSql = "select CodigoDelProceso, CodigoDePaso, Descripcion from eexxi_param_solicitudes_codigos";
