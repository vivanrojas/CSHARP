...
{
    public class PuntosActivosMT_COMPOR : EndesaEntity.contratacion.PS_AT_Tabla
    {
        public Dictionary<string, EndesaEntity.contratacion.PS_AT_Tabla> dic { get; set; }

        public PuntosActivosMT_COMPOR(List<string> lista_cups_20)
        {
        ...
        {
            string strSql = "";
            strSql = "SELECT CPE from COMPOR_OWNER.CONT_PUNTOS_ACTIVOS"
        ...
        private string GetQuery()
        {
            ...
            strSql = "SELECT  CPE, TITULAR, CIF FROM COMPOR_OWNER.CONT_PUNTOS_ACTIVOS";
