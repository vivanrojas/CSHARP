...
namespace EndesaBusiness.adif
{
    ...
    {
        private List<EndesaEntity.Adif_impuestos> impuestos = new List<EndesaEntity.Adif_impuestos>();
        ...
        public Adif_calculaImpuestos()
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    EndesaEntity.Adif_impuestos impuesto = new EndesaEntity.Adif_impuestos();
