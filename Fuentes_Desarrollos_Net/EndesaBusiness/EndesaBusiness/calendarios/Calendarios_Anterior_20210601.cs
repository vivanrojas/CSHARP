...
{
    public class Calendarios_Anterior_20210601
    {
        ...
        public double[] VectorPeriodosTarifarios { get; set; }
        ...
        public Calendarios_Anterior_20210601(DateTime fd, DateTime fh)
        {
            ...
            VectorPeriodosTarifarios = new double[numPeriodosMedidaHorario + 1];
        ...
        public Calendarios_Anterior_20210601(DateTime fd, DateTime fh, string tarifa, string territorio)
        {
        ...
        private void CargaPotenciasMaxPorPeriodo(double[] cc)
        {
            ...
            else if (ps.tarifa.tarifa.Substring(0, 1) == "6")
            {
                for (int i = 1; i <= ps.tarifa.numPeriodosTarifarios; i++)
                {
