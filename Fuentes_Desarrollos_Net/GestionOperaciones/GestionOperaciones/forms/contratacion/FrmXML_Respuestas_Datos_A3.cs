...
namespace GestionOperaciones.forms.contratacion
{
    ...
    public partial class FrmXML_Respuestas_Datos_A3 : Form
    {
        ...
        public FrmXML_Respuestas_Datos_A3()
        {
            InitializeComponent();
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            if (es_aceptacion && !DateTime.TryParse(txt_fecha_inicio.Text, out temp))
            {
            ...
            else if (!es_aceptacion && !DateTime.TryParse(maskedTextFechaRechazo.Text, out temp))
{
            ...
            if (todoOK)
            {
                ...
                if (es_aceptacion) //Es aceptacion
                {
                    ...
                    xml_a.AceptacionAlta.Contrato.FechaActivacionPrevista = Convert.ToDateTime(txt_fecha_inicio.Text).ToString("yyyy-MM-dd");
