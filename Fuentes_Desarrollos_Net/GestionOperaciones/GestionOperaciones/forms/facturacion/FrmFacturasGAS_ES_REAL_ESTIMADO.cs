...
{
    public partial class FrmFacturasGAS_ES_REAL_ESTIMADO : Form
    {

        EndesaBusiness.utilidades.UsageForm usage = new EndesaBusiness.utilidades.UsageForm();
        public FrmFacturasGAS_ES_REAL_ESTIMADO()
        {

            usage.Start("Facturación", "FrmFacturasGAS_ES_REAL_ESTIMADO" ,"N/A");
            InitializeComponent();
        }
        ...
        private void btn_excel_Click(object sender, EventArgs e)
        {
            ...
            ff.InformeExcel_FacturasGas_ES_Real_Estimada(
                Convert.ToDateTime(txt_fecha_factura_desde.Value),
                Convert.ToDateTime(txt_fecha_factura_hasta.Value));
        }

        private void FrmFacturasGAS_ES_REAL_ESTIMADO_Load(object sender, EventArgs e)
        {
        ...
        private void FrmFacturasGAS_ES_REAL_ESTIMADO_FormClosing(object sender, FormClosingEventArgs e)
        {
            usage.End("Facturación", "FrmFacturasGAS_ES_REAL_ESTIMADO" ,"N/A");
        }
    }
}
